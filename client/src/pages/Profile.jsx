...
const Profile = () => {
  ...
  return (
    <div className='p-3 max-w-lg mx-auto  rounded-lg border-white mt-7 bg-slate-300  shadow-lg shadow-white hover:scale-105 transition-shadow overflow-hidden  w-full sm:w-[500px] h-full' >
